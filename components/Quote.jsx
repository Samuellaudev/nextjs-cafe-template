      ...
      <div className="relative z-10 container grid grid-cols-1 md:grid-cols-2 gap-4 px-4 py-20 mx-auto text-center text-white">
        <div className='relative col-span-1 md:col-span-1 my-auto mx-4'>
          ...
          <div className="relative py-4">
            <ThinLine />
            <p className="mt-6 md:px-16 text-base italic font-thin text-[#66320a] leading-loose">
              "In colour definition, greytone is representing neutral, balance and relax.
              <span className='text-[#92400E] text-lg font-normal'>&nbsp;Connecting with coffee, we think balance and sweetness are essential elements of a good cup coffee.&nbsp;</span>
        ...
        <div className='col-span-1'>
          <Image
            ...
            className='mx-auto h-auto w-2/3 border-2 border-white rounded-md shadow-md'
            width={ 0 }
            height={ 0 }
            sizes='100vw'
            priority={ true }
