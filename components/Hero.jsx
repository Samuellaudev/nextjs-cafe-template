...
const Hero = () => {
  return (
    <section className="relative mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8 md:mt-10 md:mb-20">
      {/* Background Image */ }
      <div className="absolute hidden md:block inset-0 bg-cover bg-center bg-no-repeat md:rounded-md" style={ { backgroundImage: "url('/images/hero.webp')" } }></div>
      {/* Content */ }
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 md:items-center md:gap-8 border border-gray-300 p-6 rounded-md shadow-md">
        ...
        {/* Right-side - text */ }
        <div dir="md:rtl" className="relative my-10 md:my-0 max-w-lg md:max-w-none md:col-span-2 text-white p-8 shadow-md">
